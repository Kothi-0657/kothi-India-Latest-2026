        ...
        >
          ...
          >
            ...
            >
              ...
              <p className="text-gray-300 mt-3 text-lg">{selected.description}</p>
            </motion.div>
          </motion.div>
        </motion.div>
      )}
...
function Coverflow({ onOpen }: { onOpen: (p: any) => void }) {
  ...
  return (
    <section className="bg-gradient-to-b from-[#0c0c0c] via-[#101010] to-[#1a1a1a] text-white py-20 relative overflow-hidden">
      <div className="max-w-7xl mx-auto px-6 text-center">
        <h2 className="text-5xl font-serif font-bold tracking-wide mb-14 bg-gradient-to-r from-yellow-400 to-yellow-100 bg-clip-text text-transparent">
          Signature Showcase
        </h2>
        ...
        <div className="mt-10 flex items-center justify-center gap-3 overflow-x-auto py-3">
          {projects.map((p) => (
            <motion.button
  ...
  return (
    <div className="font-serif antialiased bg-black text-white">
      <main className="min-h-screen">
        ...
        <section className="py-24 bg-gradient-to-b from-[#0b0b0b] to-[#111] text-center">
          <div className="max-w-7xl mx-auto px-6">
            <h2 className="text-4xl font-semibold mb-10 tracking-widest bg-gradient-to-r from-yellow-400 to-yellow-100 bg-clip-text text-transparent">
              Explore More
            </h2>

            <div className="flex gap-6 overflow-x-auto snap-x snap-mandatory px-2 pb-4 justify-center">
              {projects.map((p) => (
                <motion.div
                  key={p.id}
